...
public class RegisterFragment extends DialogFragment implements TextView.OnEditorActionListener {
    ...
    public interface registerDialogListener{
        void onFinishRegisterDialog(String register_info, com.example.hungry.bean.PeopleInfo people);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // rpassword_reg = (TextView)view.findViewById(R.id.rpassword_reg);
        ...
        register_reg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                registerDialogListener activity = (registerDialogListener)getActivity();
                        ...
                        com.example.hungry.bean.PeopleInfo people=new com.example.hungry.bean.PeopleInfo(username_reg.getText().toString(),user_address.getText().toString(),user_phone.getText().toString(),userpass_reg.getText().toString());
    ...
    public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
        if (EditorInfo.IME_ACTION_DONE == actionId){
            ...
            com.example.hungry.fragment.LoginFragment.loginDialogListener activity = (com.example.hungry.fragment.LoginFragment.loginDialogListener)getActivity();
            com.example.hungry.bean.PeopleInfo people=new com.example.hungry.bean.PeopleInfo(username_reg.getText().toString(),user_address.getText().toString(),user_phone.getText().toString(),userpass_reg.getText().toString());
