...
public class DBAdapter {
	...
	private PeopleInfo[] ConvertToPeopleInfo(Cursor cursor){
		...
		{
			peoples[i] = new PeopleInfo(cursor.getString(cursor.getColumnIndex(KEY_NAME)), cursor.getString(cursor.getColumnIndex(KEY_ADDRESS)),cursor.getString(cursor.getColumnIndex(KEY_PHONE_NUMBER)),cursor.getString(cursor.getColumnIndex(KEY_USERPASS)));
